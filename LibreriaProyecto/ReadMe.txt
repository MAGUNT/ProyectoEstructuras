========================================================================
    APLICACIÓN DE CONSOLA: LibreriaProyecto Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación LibreriaProyecto.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación LibreriaProyecto.


LibreriaProyecto.vcxproj
...
LibreriaProyecto.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado LibreriaProyecto.pch y un archivo de tipos precompilados llamado StdAfx.obj.
