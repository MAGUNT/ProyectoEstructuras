...
MultiRepo<Carrito> Repositorios::repoCompras(fabricaMultiListaCarrito, new FileRepo<Carrito*, MultiplyList<Carrito*>>("filesystem/usuarios/compras"));
MultiRepo<Carrito> Repositorios::repoCarritos(fabricaMultiListaCarrito, new FileRepo<Carrito*, MultiplyList<Carrito*>>("filesystem/usuarios/carritos"));
Session Repositorios::session = Session();

MultiplyList<Carrito*>* Repositorios::fabricaMultiListaCarrito(){
